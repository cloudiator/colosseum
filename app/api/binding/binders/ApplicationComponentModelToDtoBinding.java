...
import api.dto.ApplicationComponentDto;
 ...
 */
public class ApplicationComponentModelToDtoBinding
    extends AbstractModelToDtoBinding<ApplicationComponent, ApplicationComponentDto> {
    ...
    @Inject
    protected ApplicationComponentModelToDtoBinding(ModelService<Application> applicationModelService,
