...
import api.dto.ApplicationInstanceDto;
 ...
 */
public class ApplicationInstanceModelToDtoBinding
    extends AbstractModelToDtoBinding<ApplicationInstance, ApplicationInstanceDto> {

    private final ModelService<Application> applicationModelService;


    @Inject
    protected ApplicationInstanceModelToDtoBinding(ModelService<Application> applicationModelService) {
