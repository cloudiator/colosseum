...
@Singleton public class CloudModelToDtoBinding extends AbstractModelToDtoBinding<Cloud, CloudDto> {

    private final ModelService<Api> apiModelService;

    @Inject protected CloudModelToDtoBinding(ModelService<Api> apiModelService) {
