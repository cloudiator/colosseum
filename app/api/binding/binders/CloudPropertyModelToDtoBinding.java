 ...
 */
public class CloudPropertyModelToDtoBinding
    extends AbstractModelToDtoBinding<CloudProperty, CloudPropertyDto> {

    private final ModelService<Cloud> cloudModelService;

    @Inject public CloudPropertyModelToDtoBinding(ModelService<Cloud> cloudModelService) {
