 ...
 */
public class CommunicationModelToDtoBinding
    extends AbstractModelToDtoBinding<Communication, CommunicationDto> {
    ...
    @Inject protected CommunicationModelToDtoBinding(ModelService<PortRequired> portRequiredModelService,
