 ...
 */
@Singleton
public class ComponentHorizontalInScalingActionModelToDtoBinding extends
    AbstractModelToDtoBinding<ComponentHorizontalInScalingAction, ComponentHorizontalInScalingActionDto> {
    ...
    @Inject
    protected ComponentHorizontalInScalingActionModelToDtoBinding(
        ...
        super(ComponentHorizontalInScalingAction.class,
                ComponentHorizontalInScalingActionDto.class);
