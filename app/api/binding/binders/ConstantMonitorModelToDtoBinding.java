...
@Singleton public class ConstantMonitorModelToDtoBinding
    extends AbstractModelToDtoBinding<ConstantMonitor, ConstantMonitorDto> {

    private final ModelService<ExternalReference> externalReferenceModelService;

    @Inject protected ConstantMonitorModelToDtoBinding(ModelService<ExternalReference> externalReferenceModelService) {
