 ...
 */
public class HardwareModelToDtoBinding extends RemoteModelToDtoBinding<Hardware, HardwareDto> {
    ...
    @Inject protected HardwareModelToDtoBinding(ModelService<HardwareOffer> hardwareOfferModelService,
