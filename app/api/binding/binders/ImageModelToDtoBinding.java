 ...
 */
public class ImageModelToDtoBinding extends RemoteModelToDtoBinding<Image, ImageDto> {
    ...
    @Inject protected ImageModelToDtoBinding(ModelService<Cloud> cloudModelService,
