 ...
 */
public class InstanceModelToDtoBinding extends RemoteModelToDtoBinding<Instance, InstanceDto> {
    ...
    @Inject protected InstanceModelToDtoBinding(ModelService<VirtualMachine> virtualMachineModelService,
