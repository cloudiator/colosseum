 ...
 */
public class IpAddressModelToDtoBinding extends AbstractModelToDtoBinding<IpAddress, IpAddressDto> {

    private final ModelService<VirtualMachine> virtualMachineModelService;

    @Inject protected IpAddressModelToDtoBinding(ModelService<VirtualMachine> virtualMachineModelService) {
