 ...
 */
public class KeyPairModelToDtoBinding extends RemoteModelToDtoBinding<KeyPair, KeyPairDto> {

    private final ModelService<Cloud> cloudModelService;
    private final ModelService<VirtualMachine> virtualMachineModelService;

    @Inject protected KeyPairModelToDtoBinding(ModelService<Cloud> cloudModelService,
