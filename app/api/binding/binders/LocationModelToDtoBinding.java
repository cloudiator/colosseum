 ...
 */
public class LocationModelToDtoBinding extends RemoteModelToDtoBinding<Location, LocationDto> {
    ...
    @Inject protected LocationModelToDtoBinding(ModelService<Location> locationModelService,
