 ...
 */
@Singleton public class MeasurementWindowModelToDtoBinding
    extends AbstractModelToDtoBinding<MeasurementWindow, MeasurementWindowDto> {

    //private final ModelService<Api> apiModelService;

    @Inject protected MeasurementWindowModelToDtoBinding() {
