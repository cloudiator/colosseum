...
@Singleton public class MonitorInstanceModelToDtoBinding
    extends AbstractModelToDtoBinding<MonitorInstance, MonitorInstanceDto> {
    ...
    @Inject protected MonitorInstanceModelToDtoBinding(ModelService<Monitor> monitorModelService,
