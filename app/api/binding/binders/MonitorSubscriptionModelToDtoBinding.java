 ...
 */
@Singleton public class MonitorSubscriptionModelToDtoBinding
    extends AbstractModelToDtoBinding<MonitorSubscription, MonitorSubscriptionDto> {

    private final ModelService<Monitor> monitorModelService;

    @Inject protected MonitorSubscriptionModelToDtoBinding(ModelService<Monitor> monitorModelService) {
