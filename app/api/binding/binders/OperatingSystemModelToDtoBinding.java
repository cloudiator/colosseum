...
import api.dto.OperatingSystemDto;
 ...
 */
public class OperatingSystemModelToDtoBinding
    extends AbstractModelToDtoBinding<OperatingSystem, OperatingSystemDto> {

    private final ModelService<OperatingSystemVendor> operatingSystemVendorModelService;

    @Inject protected OperatingSystemModelToDtoBinding(
