...
import api.dto.PortProvidedDto;
 ...
 */
public class PortProvidedModelToDtoBinding
    extends PortModelToDtoBinding<PortProvided, PortProvidedDto> {

    @Inject public PortProvidedModelToDtoBinding(
