 ...
 */
public class TemplateOptionsModelToDtoBinding
    extends AbstractModelToDtoBinding<TemplateOptions, TemplateOptionsDto> {

    protected TemplateOptionsModelToDtoBinding() {
        super(TemplateOptions.class, TemplateOptionsDto.class);
    }

    @Override public void configure() {
        binding().fromField("tags").toField("tags");
    }
}
