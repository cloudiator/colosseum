...
@Singleton public class TimeWindowModelToDtoBinding
    extends AbstractModelToDtoBinding<TimeWindow, TimeWindowDto> {

    @Inject protected TimeWindowModelToDtoBinding() {
