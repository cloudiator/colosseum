 ...
 */
public class VirtualMachineModelToDtoBinding
    extends RemoteModelToDtoBinding<VirtualMachine, VirtualMachineDto> {
    ...
    @Inject protected VirtualMachineModelToDtoBinding(ModelService<Cloud> cloudModelService,
