 ...
 */
public class VirtualMachineTemplateModelToDtoBinding
    extends AbstractModelToDtoBinding<VirtualMachineTemplate, VirtualMachineTemplateDto> {
    ...
    @Inject protected VirtualMachineTemplateModelToDtoBinding(ModelService<Cloud> cloudModelService,
