 ...
 */
public class GetWithExternalReferenceDto extends ValidatableDto {

    private List<String> externalReferences;

    public GetWithExternalReferenceDto() {
        super();
    }

    public GetWithExternalReferenceDto(List<String> externalReferences) {
