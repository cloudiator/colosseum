...
@JsonSubTypes({@JsonSubTypes.Type(value = PortProvidedDto.class, name = "portProv"),
    @JsonSubTypes.Type(value = PortRequiredDto.class, name = "portReq")})
public abstract class PortDto extends ValidatableDto {
