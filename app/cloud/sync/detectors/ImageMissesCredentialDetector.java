 ...
 */
public class ImageMissesCredentialDetector implements ProblemDetector<ImageInLocation> {

    private final ImageModelService imageModelService;

    @Inject public ImageMissesCredentialDetector(ImageModelService imageModelService) {
