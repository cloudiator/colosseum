 ...
 */
@Singleton
public class PlatformEnvironmentConverter extends AbstractConverter<PlatformEnvironment, PlatformEnvironmentDto> {
    ...
    @Inject
    protected PlatformEnvironmentConverter(ModelService<Platform> platformModelService, ModelService<PlatformHardware> platformHardwareModelService, ModelService<PlatformRuntime> platformRuntimeModelService){

        super(PlatformEnvironment.class, PlatformEnvironmentDto.class);
