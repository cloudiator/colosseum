 ...
 */
public class ApiAccessTokenServiceImpl extends ModelService<ApiAccessToken> implements ApiAccessTokenService {

    @Inject
    public ApiAccessTokenServiceImpl(ApiAccessTokenRepository apiAccessTokenRepository) {
