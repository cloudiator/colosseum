 ...
 */
public class CloudImageServiceImpl extends ModelService<CloudImage> implements CloudImageService {

    @Inject
    public CloudImageServiceImpl(CloudImageRepository cloudImageRepository) {
