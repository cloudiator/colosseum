 ...
 */
public class ImageServiceImpl extends NamedModelService<Image> implements ImageService {

    @Inject
    public ImageServiceImpl(ImageRepository imageRepository){super(imageRepository);}
}
