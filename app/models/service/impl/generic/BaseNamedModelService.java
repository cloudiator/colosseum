 ...
 */
public class BaseNamedModelService<T extends NamedModel> extends BaseModelService<T>
    implements models.service.api.generic.NamedModelService<T> {

    protected NamedModelRepository<T> modelRepository;

    public BaseNamedModelService(NamedModelRepository<T> namedModelRepository) {
